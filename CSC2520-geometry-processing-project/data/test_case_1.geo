...
w_line = scale*0.14e-3; // width of each conductor
h_line = scale*0.10e-3; // height of each conductor
bend_shift = 20*w_line; // lateral shift between the two ends of the bends
...
separation = scale*0.4e-3; // centre-to-centre lateral separation between conductors

nConductors1 = 3; // number of conductors in layer 1
...
For ww In {0:nBuses-1}
    ...
    For ii In {0:nConductors1-1}
        ...
        Point(kk) = {x3_bl+separation*ii+bend_shift*ii/2.0, y3_bl, z3_bl, lc}; kk++;
        Point(kk) = {x3_br+separation*ii+bend_shift*ii/2.0, y3_br, z3_br, lc}; kk++;
        Point(kk) = {x3_tr+separation*ii+bend_shift*ii/2.0, y3_tr, z3_tr, lc}; kk++;
        Point(kk) = {x3_tl+separation*ii+bend_shift*ii/2.0, y3_tl, z3_tl, lc}; kk++;
        ...
        Point(kk) = {x4_bl+separation*ii+bend_shift*ii/2.0, y4_bl, z4_bl, lc}; kk++;
        Point(kk) = {x4_br+separation*ii+bend_shift*ii/2.0, y4_br, z4_br, lc}; kk++;
        Point(kk) = {x4_tr+separation*ii+bend_shift*ii/2.0, y4_tr, z4_tr, lc}; kk++;
        Point(kk) = {x4_tl+separation*ii+bend_shift*ii/2.0, y4_tl, z4_tl, lc}; kk++;
